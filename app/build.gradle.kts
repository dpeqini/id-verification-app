...
dependencies {
    ...
    implementation("com.squareup.okhttp3:logging-interceptor:4.12.0")   // debug logging only
    implementation("com.squareup.retrofit2:retrofit:2.9.0")
    implementation("com.squareup.retrofit2:converter-gson:2.9.0")

    // ── Encrypted storage for JWT tokens ────────────────────────────────────
    // Backed by Android Keystore AES-256-GCM key
    implementation("androidx.security:security-crypto:1.1.0-alpha06")

    // ── QR code for vote receipt (Phase 3) ──────────────────────────────────
    implementation("com.journeyapps:zxing-android-embedded:4.3.0")

    // ── Play Integrity API (Phase 4) ─────────────────────────────────────────
